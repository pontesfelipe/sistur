...
const severityConfig: Record<Severity, { label: string; color: string; bgColor: string; progressColor: string }> = {
  ...
  FORTE: { ...SEVERITY_INFO.FORTE, bgColor: 'bg-severity-strong/10', progressColor: '[&>div]:bg-severity-strong' },
  EXCELENTE: { ...SEVERITY_INFO.EXCELENTE, bgColor: 'bg-severity-excellent/10', progressColor: '[&>div]:bg-severity-excellent' },
};
