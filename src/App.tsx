...
const EduCalendario = lazy(() => import("./pages/EduCalendario"));
const EduRecompensas = lazy(() => import("./pages/EduRecompensas"));
...
const EduHistoricoEscolar = lazy(() => import("./pages/EduHistoricoEscolar"));
